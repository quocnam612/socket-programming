...
LEGACY_DETECT_THRESHOLD = 60  # number of packets without marker before fallback
...
class Client:
	...
	def handleRtpPacket(self, rtpPacket, packetSize):
		...
		if marker:
			...
			self.noMarkerCounter += 1
			if not self.legacyMode and self.noMarkerCounter > LEGACY_DETECT_THRESHOLD:
